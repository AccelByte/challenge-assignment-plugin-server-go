...
import (
	...
	assignmentFunction "challenge-assignment-plugin-server-go/pkg/pb"
...
func main() {
	...
	assignmentServer := server.NewAssignmentServiceServer()
	assignmentFunction.RegisterAssignmentFunctionServer(grpcServer, assignmentServer)
